...
public class Ilmoittautuminen extends Perustoiminnallisuus
{
   ...
   {
      public Aikaraja(Viikonpäivä päivä, Date aika)
      {
         this.päivä = päivä;
         this.aika = aika;
      }
   ...
   private Aikaraja haeAikaraja()
   {
      ...
      Viikonpäivä päivä = Viikonpäivä.values()[kalenteri.get(Calendar.DAY_OF_WEEK) - 1];
      kalenteri.clear();
      kalenteri.set(Calendar.HOUR, tunti);
      kalenteri.set(Calendar.MINUTE, minuutti);
      return new Aikaraja(päivä, kalenteri.getTime());
   }
