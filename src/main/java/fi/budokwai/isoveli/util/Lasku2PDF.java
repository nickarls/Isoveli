...
public class Lasku2PDF
{
   ...
   private class Vastaanottaja
   {
      ...
      public Vastaanottaja(Harrastaja harrastaja)
      {
         ...
         {
            henkilˆ = harrastaja.getHuoltaja();
   ...
   private class Otsikkotiedot
   {
      ...
      public Otsikkotiedot(Lasku lasku)
      {
         ...
         yhteyshenkilˆ = lasku.getHarrastaja().getHuoltaja() != null ? "Huoltaja" : "Harrastaja";
         toimituspvm = "jatkuva";
      }
   }
   ...
   private PdfPTable teeOsoite(Vastaanottaja vastaanottaja)
   {
      ...
      lis‰‰Solu(taulukko, vastaanottaja.henkilˆ.getNimi(), Formatointi.V_DATA);
      lis‰‰Solu(taulukko, vastaanottaja.osoite.getOsoite(), Formatointi.V_DATA);
      lis‰‰Solu(taulukko,
