...
insert into harrastaja (id, huoltaja, jasennumero, syntynyt, sukupuoli) values (2, 1, '19760908-1', parsedatetime('09.08.1976', 'dd.MM.yyyy'), 'N');
insert into harrastaja (id, huoltaja, jasennumero, syntynyt, sukupuoli) values (3, 1, '20053010-1', parsedatetime('30.10.2005', 'dd.MM.yyyy'), 'M');
