...
insert into lasku(id, henkilo, erapaiva, maksettu, tila, viitenumero, muodostettu) values (1, 1, parsedatetime('14.1.2013', 'dd.MM.yyyy'), parsedatetime('14.1.2013', 'dd.MM.yyyy'), 'M', 12345, parsedatetime('1.1.2013', 'dd.MM.yyyy'));
