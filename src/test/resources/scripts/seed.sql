...
insert into vyoarvo (id, nimi, kuvaus, minimikuukaudet, minimitreenit, jarjestys) values (9, '1.poom', 'Poom I', 6, 60, 9);
insert into vyoarvo (id, nimi, kuvaus, minimikuukaudet, minimitreenit, jarjestys) values (10, '1.dan', 'Dan I', 6, 60, 10);
insert into vyoarvo (id, nimi, kuvaus, minimikuukaudet, minimitreenit, jarjestys) values (11, '2.poom', 'Poom II', 24, 200, 11);
insert into vyoarvo (id, nimi, kuvaus, minimikuukaudet, minimitreenit, jarjestys) values (12, '2.dan', 'Dan II', 24, 200, 12);
insert into vyoarvo (id, nimi, kuvaus, minimikuukaudet, minimitreenit, jarjestys) values (13, '3.poom', 'Poom III', 36, 300, 13);
insert into vyoarvo (id, nimi, kuvaus, minimikuukaudet, minimitreenit, jarjestys) values (14, '3.dan', 'Dan III', 36, 300, 14);
insert into vyoarvo (id, nimi, kuvaus, minimikuukaudet, minimitreenit, jarjestys) values (15, '4.poom', 'Poom IV', 48, 400, 15);
insert into vyoarvo (id, nimi, kuvaus, minimikuukaudet, minimitreenit, jarjestys) values (16, '4.dan', 'Dan IV', 48, 400, 16);
insert into vyoarvo (id, nimi, kuvaus, minimikuukaudet, minimitreenit, jarjestys) values (17, '5.dan', 'Dan V', 60, 500, 17);
insert into vyoarvo (id, nimi, kuvaus, minimikuukaudet, minimitreenit, jarjestys) values (18, '6.dan', 'Dan VI', 72, 600, 18);
